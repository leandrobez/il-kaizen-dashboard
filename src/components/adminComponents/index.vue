...
<div class="il-admin">
    <div class="il-admin--content">
        ...
        <h3 class="il-color--darkblue">Controle de Administradores</h3>
        <div class="il-sub--menu">
            <a href="#!" class="il-btn il-btn--submit" @click.prevent="createAdmin"><i class="mdi mdi-24px mdi-account-multiple" title="Novo Admin"></i><span>Novo Admin</span></a>
        </div>
        <table>
            <thead>
                <tr>
